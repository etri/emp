...
static void free_nested(struct kvm_vcpu *vcpu)
{
	...
	kvm_clear_request(EMP_KVM_REQ_GET_NESTED_STATE_PAGES, vcpu);
							...
							bool from_vmentry)
{
	...
	if (from_vmentry) {
		 ...
		 */
		kvm_make_request(EMP_KVM_REQ_GET_NESTED_STATE_PAGES, vcpu);
	}
...
struct kvm_x86_nested_ops vmx_nested_ops = {
	...
	.emp_get_nested_state_pages = nested_get_vmcs12_pages,
